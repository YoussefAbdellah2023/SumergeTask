...
public class ScreenRecorderUtils extends org.monte.screenrecorder.ScreenRecorder  {
    ...
    public final static String RECORDINGS_PATH = "target/surefire-reports/";
    ...
    public static void startRecording(String fileName) throws Exception {
        try {
            ...
            E2ELogger.logger.debug(e.getMessage());
        }
    ...
    public static void startRecording(WebDriver driver, String testClassName, String testMethodName) {
    }
